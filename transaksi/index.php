...
$sql = "SELECT * FROM peminjaman INNER JOIN anggota ON peminjaman.id_anggota = anggota.id_anggota INNER JOIN petugas on peminjaman.id_petugas = petugas.id_petugas ORDER BY peminjaman.tgl_pinjam";
                    ...
                    <table class="table table-striped ">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>REEEEE</td>
                                <td>1 Januari 1111</td>
                                <td>1 Februari 1111</td>
                                <td>Dipinjam</td>
                                <td>
